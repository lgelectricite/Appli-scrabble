...
| ♠️ **Blackjack** | 1–4 | Face au croupier, sur la table en demi-lune : **composez votre mise en empilant les jetons** (1, 5, 25, 100, 500 — n'importe quel montant, 50 comme 137), effacez-la si besoin, puis validez, tirez, restez, doublez ou **séparez les paires** (deux mains jouées l'une après l'autre). À plusieurs, chacun a **sa place à la table** (plaque et cartes). Blackjack payé **3 pour 2**, le croupier tire jusqu'à 17. Chacun mise la cagnotte de **son** téléphone. |
