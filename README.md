...
| 🟩 **Mot Mystère** | 1–4 | Type Motus/Wordle **en série sans fin** : 6 essais par mot, puis on enchaîne le suivant — compteur de mots trouvés, série d'affilée 🔥 et record de série. Mots courants, propositions vérifiées au dictionnaire, 3 niveaux (5/6/7 lettres). En duel : même mot, les lettres adverses restent cachées. |
...
| ♠️ **Blackjack** | 1–4 | Face au croupier : misez vos **jetons de la cagnotte** (de 1 à 500), tirez, restez, doublez ou **séparez les paires** (deux mains jouées l'une après l'autre). Blackjack payé **3 pour 2**, le croupier tire jusqu'à 17. Chacun mise la cagnotte de **son** téléphone. |
